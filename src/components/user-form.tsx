        ...
        >
            <div className="flex flex-col">
                ...
                <div className="dropdown dropdown-hover w-full my-4">
                    <label tabIndex={0} className="btn w-full text-primary flex justify-between bg-gray-700 hover:bg-gray-600 text-base border-none shadow-none">
                        {scOrUni}
                        <ChevronDown />
                    </label>
                ...
                <div className="dropdown dropdown-hover w-full my-4">
                    <label tabIndex={0} className="btn w-full text-primary flex justify-between bg-gray-700 hover:bg-gray-600 text-base border-none shadow-none">
                        {feeType.length === 0 ? "Fee Type" : feeType}
                        <ChevronDown />
                    </label>
                    <ul tabIndex={0} className="dropdown-content menu bg-white rounded-lg w-full shadow-md">
